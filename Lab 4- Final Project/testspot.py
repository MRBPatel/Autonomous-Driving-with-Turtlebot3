...
class wallfollower():
    ...
    def odometry_callback(self, msg):
        ...
        print('22222')
        print(self.zero_pose)
        print(self.zero_pose1)
        print('11111')
        print(self.parking_spot)
        print('11122')
        #print("Total t : ", self.t)
        print("distance2goal: ", self.dist2goal)
        print("scan of detected point: ",self.end1)
    ...
    def check(self):
        ...
        while not rospy.is_shutdown(): 
            ...
            if self.dt > 8:
                self.dist = self.dist2goal
            if self.dt > 20 and self.end1 and self.dist < 0.5: 
                break 
